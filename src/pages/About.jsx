    ...
    <>
      ...
      >
        ...
        <Row className="text-center pt-3">
          <Col>
            <img src={nikon} alt="Nikon logo image" className="nikonLogo" />
          </Col>
        </Row>
        <Row className="cameraBag text-center pt-3">
          <Col xs={12} className="pb-3 itemRow">
            <h2>
              <a
                href="https://www.nikonusa.com/p/d850/1585"
                target="_blank"
          ...
          <Col xs={12} className="pb-3 itemRow">
            <h2>
              <a
                href="https://photographylife.com/reviews/nikon-40mm-f2-8g-dx"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <Col xs={12} className="pb-3 itemRow">
            <h2>
              <a
                href="https://photographylife.com/reviews/nikon-18-35mm-f3-5-4-5g"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <Col xs={12} className="pb-3 lastRow">
            <h2>
              <a
                href="https://www.adobe.com/products/photoshop-lightroom/campaign/pricing.html?sdid=BDDS3CR2&mv=search&mv2=paidsearch&ef_id=1becb68328f51f63b7fdd0fa882aa3d5:G:s&s_kwcid=AL!3085!10!79783520125068!20678565233"
                target="_blank"
                rel="noopener noreferrer"
              >
